...
import trainingSection from "./assets/training-section.png";
import kitchenSecondary from "./assets/kitchen-secondary.png";
import institutionalOffice from "./assets/institutional-office.png";
...
export default function App() {
  ...
  const renderInicio = () => (
    <>
        ...
        <div className="mx-auto max-w-[1450px] px-6 py-10 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="pt-2">
              ...
              <h1 className="heading-serif mt-5 max-w-[720px] text-[2.45rem] leading-[1.05] text-[#18305c] md:text-[3.45rem]">
                Construye una carrera comercial con formación, acompañamiento y proyección real.
              </h1>

              <p className="mt-5 max-w-[680px] text-[1rem] leading-8 text-slate-600">
                En Living Paradise estamos en proceso de expansión y buscamos personas con actitud, disciplina y deseo real de crecer. Esta oportunidad está pensada para quienes quieren desarrollarse en el área comercial dentro de un entorno serio, bien guiado y orientado a resultados.
              </p>

              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <PrimaryButton onClick={() => setActivePage("equipo")}>Postúlate ahora</PrimaryButton>
                <SecondaryButton onClick={() => setActivePage("equipo")}>Conocer la oportunidad</SecondaryButton>
              </div>
            </div>
      ...
      <section className="border-b border-[#dde3ee] bg-white">
        <div className="mx-auto max-w-[1450px] px-6 py-12 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.95fr] lg:items-center">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.32em] text-[#1263b8]">¿Qué harás dentro del equipo?</p>
              <h2 className="heading-serif mt-4 text-[2.15rem] leading-tight text-[#1d2e55] md:text-[2.8rem]">
                Desarrollarás habilidades comerciales dentro de una estructura guiada y profesional.
              </h2>
              <p className="mt-4 max-w-[620px] text-[1rem] leading-8 text-slate-600">
                La oportunidad está enfocada en el desarrollo de habilidades comerciales, relacionamiento con clientes y ejecución dentro de una operación seria, bien presentada y orientada a resultados.
              </p>

              <div className="mt-6 grid gap-3">
                {[
                  "Participar en actividades comerciales y de relacionamiento.",
                  "Fortalecer habilidades en ventas, comunicación y negociación.",
                  "Trabajar con acompañamiento y formación práctica.",
                  "Crecer dentro de una operación enfocada en resultados.",
                ].map((item) => (
                  <div key={item} className="flex items-start gap-3 rounded-xl border border-[#d7deea] bg-[#f8fbff] px-4 py-4 text-sm leading-7 text-slate-700">
                    <span className="mt-1 text-[#c9a15a]"><CheckIcon /></span>
                    <span>{item}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="overflow-hidden rounded-[1.6rem] border border-[#d7deea] bg-white shadow-[0_14px_32px_rgba(17,39,81,0.08)]">
              <img
                src={trainingSection}
                alt="Capacitación comercial Living Paradise"
      ...
      <section className="border-b border-[#dde3ee] bg-[#f7f9fc]">
        <div className="mx-auto max-w-[1450px] px-6 py-12 lg:px-10">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-[1.45rem] border border-[#e3d4ba] bg-[#fffaf2] p-7 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#8b6528]">¿Qué ofrecemos?</p>
              <ul className="mt-5 grid gap-3 text-sm leading-7 text-slate-700">
                {[
                  "Formación estructurada en ventas y negociación.",
                  "Acompañamiento en campo y desarrollo comercial.",
                  "Proyección interna basada en desempeño.",
                  "Entorno profesional orientado a resultados.",
                  "Desarrollo dentro de una marca con enfoque en experiencia y bienestar.",
                ].map((item) => (
            ...
            <div className="rounded-[1.45rem] border border-[#d7deea] bg-white p-7 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#1263b8]">Perfil que buscamos</p>
              <p className="mt-4 text-sm leading-7 text-slate-600">
                Buscamos personas con buena actitud, enfoque y disposición para crecer dentro del área comercial.
              </p>
              <ul className="mt-5 grid gap-3 text-sm leading-7 text-slate-700">
                {[
                  "Habilidades de comunicación y relacionamiento.",
                  ...
                  "Interés en el desarrollo profesional.",
                  "Actitud comercial y enfoque en resultados.",
                  "Capacidad para aprender, ejecutar y seguir procesos.",
                ].map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    <span className="mt-0.5 text-[#123d8c]"><CheckIcon /></span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="border-b border-[#dde3ee] bg-white">
        <div className="mx-auto max-w-[1450px] px-6 py-12 lg:px-10">
          <div className="flex items-center justify-center gap-6">
            ...
            <h2 className="heading-serif text-[2rem] text-[#24395d] md:text-[2.25rem]">¿Cómo funciona el proceso?</h2>
            <div className="h-px flex-1 max-w-[110px] bg-[#d8b884]" />
          </div>

          <div className="mt-8 grid gap-6 lg:grid-cols-4">
            <StepCard number="1" title="Postúlate" text="Completa el formulario o envíanos tu hoja de vida." />
            <StepCard number="2" title="Revisamos tu perfil" text="Nuestro equipo evalúa tu información y valida si hay ajuste." />
            <StepCard number="3" title="Conoces la oportunidad" text="Te presentamos la propuesta, el enfoque de trabajo y la ruta de acompañamiento." />
            <StepCard number="4" title="Inicias tu proceso" text="Si avanzas, comienzas tu etapa de formación e integración al equipo." />
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-[#dde3ee] bg-[#f7f9fc]">
        <div className="mx-auto max-w-[1450px] px-6 py-12 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="overflow-hidden rounded-[1.6rem] border border-[#d7deea] bg-white shadow-[0_14px_32px_rgba(17,39,81,0.08)]">
              <img
                src={institutionalOffice}
                alt="Oficina institucional Living Paradise"
                className="h-[300px] w-full object-cover object-center md:h-[420px]"
              />
            </div>

            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.32em] text-[#1263b8]">Respaldo institucional</p>
              <h2 className="heading-serif mt-4 text-[2.1rem] leading-tight text-[#1d2e55] md:text-[2.8rem]">
                Una marca enfocada en experiencia, bienestar y crecimiento comercial.
              </h2>
              <p className="mt-5 max-w-[620px] text-[1rem] leading-8 text-slate-600">
                Living Paradise desarrolla experiencias bien presentadas en el hogar y construye una operación comercial seria, ordenada y orientada al crecimiento. Nuestro objetivo es proyectar confianza, profesionalismo y una propuesta bien estructurada tanto para clientes como para nuevos integrantes del equipo.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-b border-[#dde3ee] bg-white">
        <div className="mx-auto max-w-[1450px] px-6 py-12 lg:px-10">
          <div className="grid gap-10 overflow-hidden rounded-[1.8rem] border border-[#d7deea] bg-[#f8fbff] p-7 shadow-[0_14px_34px_rgba(17,39,81,0.06)] lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <h2 className="heading-serif mt-5 max-w-[560px] text-[2.1rem] leading-tight text-[#1d2e55] md:text-[2.8rem]">
                Si buscas estructura, acompañamiento y visión comercial, queremos conocerte.
              </h2>
              <p className="mt-4 max-w-[560px] text-[1rem] leading-8 text-slate-600">
                Completa el formulario para iniciar tu proceso. También puedes escribirnos por WhatsApp o enviarnos tu hoja de vida por correo.
              </p>
              ...
              <div className="mt-6 rounded-[1.2rem] border border-[#e3d4ba] bg-white p-4 text-sm leading-7 text-slate-700">
                <p><span className="font-semibold text-[#24395d]">Correo:</span> contrataciones@livingparadise.com.co</p>
                <p><span className="font-semibold text-[#24395d]">WhatsApp / Teléfono:</span> 322 713 3590</p>
              </div>
            </div>

            <div className="overflow-hidden rounded-[1.2rem] border border-[#d7deea] bg-white">
              <iframe
      ...
      <section className="mx-auto max-w-[1450px] px-6 py-14 lg:px-10">
        <div className="grid gap-10 overflow-hidden rounded-[1.8rem] border border-[#e3d4ba] bg-gradient-to-r from-[#fffaf2] via-white to-[#f8fbff] p-7 shadow-[0_14px_34px_rgba(17,39,81,0.06)] lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <div className="inline-flex rounded-full bg-[#f4e7d0] px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-[#8b6528]">
              También desarrollamos experiencias de cocina en casa
            </div>
            <h2 className="heading-serif mt-5 max-w-[560px] text-[2rem] leading-tight text-[#1d2e55] md:text-[2.6rem]">
              Conoce nuestros talleres y demostraciones con una experiencia clara, elegante y bien guiada.
            </h2>
            <p className="mt-4 max-w-[560px] text-[1rem] leading-8 text-slate-600">
              Si deseas conocer nuestras demostraciones y talleres en casa, también puedes solicitar información y vivir una experiencia práctica, saludable y bien presentada junto a tu familia.
            </p>
          ...
          <div className="overflow-hidden rounded-[1.6rem] border border-[#d7deea] bg-white shadow-[0_14px_32px_rgba(17,39,81,0.08)]">
            <img
              src={kitchenSecondary}
              alt="Experiencia de cocina en casa Living Paradise"
